...
//				log.info("inside findProductById method of controller");
	...
	@PostMapping("/product")
	public ResponseEntity<Product> addProduct(@Valid @RequestBody Product product, BindingResult bindingResult) throws ResponseStatusException{
		Product prod = null;
		try {
			if(bindingResult.hasErrors()) {
				throw new ProductOperationException(bindingResult.getAllErrors().toString());
			}
